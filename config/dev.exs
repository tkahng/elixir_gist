...
config :elixir_gist, ElixirGistWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "zL8Wm+Pj/ypJa67cxZsKGihTv3RrW7/MMC7v0ObCCyPidRu+xztTY1gQ7tG4sAH8",
  watchers: [
...
config :elixir_gist, ElixirGistWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/elixir_gist_web/router\.ex$"E,
      ~r"lib/elixir_gist_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
